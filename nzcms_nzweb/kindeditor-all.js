...
filterMode : false,
	...
	fontSizeTable : ['9px', '10px', '12px', '14px', '16px', '18px', '19px', '20px', '21px', '22px', '23px', '24px', '28px', '32px', '36px', '48px'],
	htmlTags : {
...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	var arr = [
		...
		'<head><meta charset="GB2312" /><title></title>',
		'<style>',
	...
	self.plugin.table = {
		...
		rowmerge : function() {
			var table = self.plugin.getSelectedTable()[0],
				...
				nextRow = table.rows[nextRowIndex]; // 下一�?
			// 最后一行不能合�?
